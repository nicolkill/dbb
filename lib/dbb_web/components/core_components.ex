defmodule DbbWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    ~H"""
    <div
      :if={msg = render_slot(@inner_block) || @flash[@kind]}
      id={@id}
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(DbbWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(DbbWeb.Gettext, "errors", msg, opts)
    # end
